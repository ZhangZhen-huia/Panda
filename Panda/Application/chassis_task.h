...
/*******************************一节低通滤波参数************************/
#define CHASSIS_CONTROL_TIME 0.05f   //x和y本次信任参数
#define CHASSIS_CONTROL_TIME_Z 0.05f  //z本次信任参数
#define CHASSIS_CONTROL_TIME_3508 0.05f   //3508本次信任参数

//信任上一次参数占比
#define CHASSIS_ACCEL_X_NUM 0.95f
#define CHASSIS_ACCEL_Y_NUM 0.95f
#define CHASSIS_ACCEL_Z_NUM 0.95f
...
/**************************************ECD初始化************************/
//小陀螺 
#define GIM_TOP_ECD1				6915.0f
#define GIM_TOP_ECD2				2244.0f
#define GIM_TOP_ECD3				2567.0f
#define GIM_TOP_ECD4				1031.0f

//y轴
#define GIM_Y_ECD_1				8116.0f
#define GIM_Y_ECD_2				5250.0f // 6024
#define GIM_Y_ECD_3				7599.0f // 7515
#define GIM_Y_ECD_4				390.0f	//1682

//自动
#define GIM_AUTO_ECD_1				4020.0f
#define GIM_AUTO_ECD_2				1154.0f
#define GIM_AUTO_ECD_3				3503.0f
#define GIM_AUTO_ECD_4				315.0f
